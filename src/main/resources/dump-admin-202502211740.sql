...
--
-- Host: 34.47.64.102    Database: admin
-- ------------------------------------------------------
...
CREATE TABLE `tb_api` (
  `api_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'API 정보아이디',
  `api_url` varchar(100) DEFAULT NULL COMMENT 'API주소',
  PRIMARY KEY (`api_id`)
...
CREATE TABLE `tb_article` (
  `article_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '게시글ID',
  `article_content` varchar(600) DEFAULT NULL COMMENT '게시글내용',
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `reg_id` varchar(100) NOT NULL COMMENT '등록자',
  `article_title` varchar(100) DEFAULT NULL COMMENT '게시글제목',
  `upd_id` varchar(100) NOT NULL COMMENT '등록자',
  `updated_at` timestamp NULL DEFAULT current_timestamp(),
  `board_id` bigint(20) NOT NULL COMMENT '게시판ID',
...
INSERT INTO `tb_article` VALUES (1,'내용1','2025-02-19 07:59:58','admin','기사제목1','admin','2025-02-19 07:59:58',1),(2,'내용2','2025-02-19 07:59:59','admin','기사제목2','admin','2025-02-19 07:59:59',1),(3,'내용3','2025-02-19 07:59:59','admin','기사제목3','admin','2025-02-19 07:59:59',1),(4,'내용4','2025-02-19 07:59:59','admin','기사제목4','admin','2025-02-19 07:59:59',1),(5,'내용5','2025-02-19 07:59:59','admin','기사제목5','admin','2025-02-19 07:59:59',1),(6,'내용6','2025-02-19 07:59:59','admin','기사제목6','admin','2025-02-19 07:59:59',1),(7,'내용7','2025-02-19 07:59:59','admin','기사제목7','admin','2025-02-19 07:59:59',1),(8,'112222222222222',NULL,'yellowplace','11111111111','yellowplace',NULL,1),(9,'vzxcvzxcvz',NULL,'yellowplace','zxcvzxcvzxc','yellowplace',NULL,1),(10,'vzxcvzxcvz',NULL,'yellowplace','zxcvzxcvzxc','yellowplace',NULL,1),(11,'112222222',NULL,'yellowplace','111111','yellowplace',NULL,1),(12,'123123123',NULL,'yellowplace','123123132','yellowplace',NULL,1),(13,'ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ',NULL,'yellowplace','ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ','yellowplace',NULL,1);
...
CREATE TABLE `tb_board` (
  `board_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '게시판ID',
...
INSERT INTO `tb_board` VALUES (1,'게시판A','2025-02-19 07:58:16','admin','admin','2025-02-19 07:58:16'),(2,'게시판B','2025-02-19 07:58:16','admin','admin','2025-02-19 07:58:16');
...
CREATE TABLE `tb_member` (
  `member_id` varchar(100) NOT NULL COMMENT '사용자계정명',
  `password` varchar(100) NOT NULL COMMENT '사용자비번',
...
INSERT INTO `tb_menu` VALUES (1,'메인','/main'),(2,'게시판','/board'),(3,'게시판쓰기','/board/write');
...
CREATE TABLE `tb_menu_api` (
  `menu_api_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '메뉴 API아이디',
  `api_id` bigint(20) DEFAULT NULL COMMENT 'API 정보아이디',
  `menu_id` bigint(20) DEFAULT NULL COMMENT '메뉴아이디',
...
CREATE TABLE `tb_menuperm` (
  `menu_perm_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '권한별 메뉴',
  `menu_perm_value` bigint(20) NOT NULL COMMENT '실제메뉴권한 수치',
...
INSERT INTO `tb_menuperm` VALUES (1,15,1),(2,15,2),(3,15,3);
...
CREATE TABLE `tb_perm` (
  `perm_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '사용자권한ID',
  `perm_nm` varchar(80) NOT NULL COMMENT '사용자권한명',
  `perm_val` bigint(20) NOT NULL COMMENT '사용자권한총수치',
  PRIMARY KEY (`perm_id`)
...
CREATE TABLE `tb_role` (
  ...
  `role_description` varchar(100) NOT NULL COMMENT '권한설명',
  `role_nm` varchar(100) NOT NULL COMMENT '권한명',
  `role_priorty` bigint(20) NOT NULL COMMENT '권한우선순위',
  PRIMARY KEY (`role_id`),
...
CREATE TABLE `tb_role_menu_api` (
  `role_menu_api_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `menu_api_id` bigint(20) DEFAULT NULL COMMENT '메뉴 API아이디',
...
CREATE TABLE `tb_role_menuperm` (
  `role_menuperm_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `menu_perm_id` bigint(20) NOT NULL COMMENT '권한별 메뉴',
  `role_id` bigint(20) NOT NULL COMMENT '권한아이디',
...
INSERT INTO `tb_role_menuperm` VALUES (1,1,1),(2,2,1),(3,1,2),(4,3,1);
...
-- Dump completed on 2025-02-21 17:40:10
